...
#### 4. Minting DSC
If the user’s Health Factor remains above the minimum threshold, the `DSCEngine` mints the requested amount of DSC through the DecentralizedStableCoin contract
