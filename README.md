...
* Read the project documentation carefully before interacting with the protocol to understand its collateral requirements, minting process, redemption flow, liquidation mechanics, and
