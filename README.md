...
* ****Modular Contract Architecture****: Separates protocol responsibilities between `DSCEngine`, `DecentralizedStableCoin`, and OracleLib,reducing contract complexity,
