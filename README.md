...
A user begins by depositing an approved collateral asset, such as WETH or WBTC, into the `DSCEngine` contract. The protocol records the deposited amount in the user’s
