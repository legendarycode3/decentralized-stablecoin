...
## Gas Optimization 
The protocol is designed with gas efficiency in mind. The following optimization mechanisms are applied across the smart contracts to reduce deployment size,
