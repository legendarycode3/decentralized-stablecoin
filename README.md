...
### `OracleLib.sol`
The `OracleLib` library provides a safe abstraction for interacting with Chainlink Price Feeds. It validates oracle responses by checking for stale price data before allowing prices
