...
For convenience, users can deposit collateral and mint DSC atomically using the `depositCollateralAndMintDsc()` function. This combines both operations into a single transaction,
