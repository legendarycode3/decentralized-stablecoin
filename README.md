...
* `Liquidation(address collateral, address user, uint256 debtToCover)`: Allows a third party to liquidate an undercollateralized position by repaying a portion of
