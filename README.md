...
Before minting DSC, the protocol calculates the user’s `Health Factor`, which represents the safety of the collateralized position. </br>
...
* ****Reentrancy Protection****: Secures critical functions against reentrancy attacks.
...
* ****OpenZeppelin Contracts****: Provides secure and audited smart contract implementations, including ERC-20 token standards, ownership management,
