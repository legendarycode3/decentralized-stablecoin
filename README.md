...
* `depositCollateralAndMintDsc(address tokenCollateralAddress, uint256 amountCollateral, uint256 amountDscToMint)`: Combines collateral deposit and DSC minting into a single atomic transaction,
