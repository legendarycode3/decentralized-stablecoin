...
* ****Event-Based Activity Tracking****: Records protocol activities such as collateral deposits and collateral redemptions through events instead of additional storage variables,
