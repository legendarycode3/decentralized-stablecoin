...
* `redeemCollateral(address tokenCollateralAddress, uint256 amountCollateral)`: Withdraws deposited collateral from the protocol, provided the user’s health factor remains above the minimum
