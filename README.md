...
The protocol is designed with a modular architecture, leveraging OpenZeppelin security standards, Chainlink decentralized price feeds, and a health factor model to
