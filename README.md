...
* ****`DecentralizedStableCoin (DSC)`****: An ERC-20 compliant stablecoin contract whose minting and burning are exclusively controlled by the `DSCEngine`, ensuring that new DSC can only be created when sufficient
